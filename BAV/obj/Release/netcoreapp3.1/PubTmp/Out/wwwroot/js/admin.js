$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response) {
                    ...
                    //$('#modal-search')
                    //document.getElementById('modal-search').setAttribute("class", "modal fade");
                    //document.getElementById('modal-search').setAttribute("style", "display: none !important;");
                    //$(document).removeClass('modal-backdrop fade in');
                }
                else {
    ...
    function Add() {
        ...
        model.CustId = 14; // parseInt(document.getElementById("txt-custId").value);
    ...
    function Save() {
        ...
        model.PlantId = 1
        model.CustId = 14; //parseInt($('#txt-custid').val());
